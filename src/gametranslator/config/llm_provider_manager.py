...
class LLMProviderManager:
    """
    Handles loading, saving, and managing LLM provider templates
    from a JSON configuration file.
    """
    def __init__(self, config_path: str = "src/gametranslator/config/llm_providers.json"):
    ...
    def add_provider(self, name: str, base_url: str, models: List[str]) -> bool:
        ...
        if self.get_provider_by_id(provider_id):
            # If simple ID conflicts, add a number
            i = 1
        ...
        new_provider = {
            ...
            "base_url": base_url,
            "models": models,
            "deletable": True  # Custom providers are always deletable
        }
